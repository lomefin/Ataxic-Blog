...
this.MooEditable = new Class({
	...
	options: {
		...
		handleLabel: true,
		disabled: false,
		baseCSS: 'html{ height: 100%; cursor: text; } body{ font-family: sans-serif; color: black; background-color:black; background-image:none; }',
		extraCSS: '',
		externalCSS: '/css/main_template.css',
		html: '<!DOCTYPE html><html><head><meta charset="UTF-8">{BASEHREF}<style>{BASECSS} {EXTRACSS}</style>{EXTERNALCSS}</head><body style="color: black; background-image:none;"></body></html>',
		rootElement: 'p',
		baseURL: '',
		dimensions: null
	},
